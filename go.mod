module github.com/arkvt/langchaingo
...
//   - import "github.com/arkvt/langchaingo/llms/openai" → only OpenAI-related deps
//   - import "github.com/arkvt/langchaingo/vectorstores/chroma" → only Chroma deps
